...
export const FarnsworthLanternTest = () => {
  ...
  return (
    <>
      <SEO
        title="Farnsworth Lantern Test (FALANT)"
        description="Experience the Farnsworth Lantern Test (FALANT) simulation. Designed for maritime and aviation industry standards, this test evaluates your ability to identify and distinguish colored signal lights crucial for safety operations."
        keywords={[
          "farnsworth lantern test",
          "FALANT",
          "signal light test",
          "maritime color vision",
          "aviation color test",
          "occupational color screening",
          "professional vision test"
        ]}
      />
