...
export const AnomaloscopeTest = () => {
  ...
  return (
    <>
      <SEO
        title="Anomaloscope Test"
        description="Experience a digital version of the Nagel anomaloscope test. This precise color matching test helps diagnose specific types and severity of red-green color vision deficiencies through detailed color discrimination assessment."
        keywords={[
          "anomaloscope test",
          "nagel anomaloscope",
          "color matching test",
