...
export const IshiharaTest = () => {
  ...
  return (
    <>
      <SEO
        title="Ishihara Test"
        description="Take the standard Ishihara color blindness test online. This test uses pseudoisochromatic plates to detect red-green color vision deficiencies through a series of numbered patterns."
        keywords={[
          "ishihara test",
